...
#
# Script @__AnyLabel__ from content/tutorials/naming/globber.md 
#
#----------------------------------------------------------------------#  Start 1 of 9
echo "# @newFileService (block #1 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 2 of 9
echo "# @newDirService (block #2 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 3 of 9
echo "# @newDispatcher (block #3 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 4 of 9
echo "# @newMain (block #4 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 5 of 9
echo "# @startMountTable (block #5 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 6 of 9
echo "# @buildServer (block #6 in __AnyLabel__) of content/tutorials/naming/globber.md"

go install fileserver
#----------------------------------------------------------------------#  End 6 of 9

#----------------------------------------------------------------------#  Start 7 of 9
echo "# @runServer (block #7 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 8 of 9
echo "# @glob (block #8 in __AnyLabel__) of content/tutorials/naming/globber.md"
...
#----------------------------------------------------------------------#  Start 9 of 9
echo "# @cleanup (block #9 in __AnyLabel__) of content/tutorials/naming/globber.md"
